...
const ShowRecentBlog = ({ blog }) => {
    ...
    return (
        <div>
            <div className="rounded-lg shadow-xs dark:bg-gray-50 dark:text-gray-800 flex flex-col h-full transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                {/* Blog Image */}
